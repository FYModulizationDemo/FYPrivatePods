...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/FYModulizationDemo/AModule"
  ...
  s.source       = { :git => "https://github.com/FYModulizationDemo/AModule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "AModule/AModule/**/*.{h,m}"
